 ...
 * @author alexplusde,
 *
 * @package redaxo\hello
 *
 * @var rex_addon $this
 */
echo rex_view::title($this->i18n('hello'));

$content = file_get_contents(rex_path::addon('hello')."README.md");
$content_blocks = [];
$h2_blocks = explode("\n## ", "\n".$content);
    ...
    if (isset($headline[1])) {
        ...
        if (count($matches[0]) > 0) {
            ...
            foreach ($navi_elements as $h3_i => $navi_element) {
                $navi_list[] = '	* <a href="index.php?page=hello/docs&amp;n=chapter'.$h2_i.'#section'.$h3_i.'">'.$navi_element.'</a>';
...
$fragment->setVar('title', rex_i18n::msg('hello_docs_navigation').'', false);
...
$fragment = new rex_fragment();
$fragment->setVar('title', $this->i18n('docs').' [ <a href="https://github.com/alexplusde/hello/blob/master/README.md">README.md</a> ]', false);
